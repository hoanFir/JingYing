...
6.1 **当我们利用excel、iSlide智能图表等工具制作的图表，在将其用在ppt上时依然存在很多可以优化的地方。**
...
场景1：复制粘贴
新建一个图形并选中，复制粘贴到图表中，如单击柱状图右键粘贴即可将自定义图形覆盖柱状图的柱形。


场景2：复制粘贴+层叠
对于人口水平柱状图，新建一个人形图形，复制粘贴到柱状图里；接着，在柱状图上右键选择“设置数据系列格式”，选择“填充与线条/油漆桶”，单击“层叠”，即可实现将人形图形层叠到各个柱状上。

场景3：复制粘贴+层叠缩放
对于柱状图中每根柱状图上展示的数据是性别对比，可以准备两个小人图形，表示男性女性；先把男性人形复制到蓝色数据柱状图上，接着在柱状图上右键选择“设置数据系列格式”，选择“填充与线条/油漆桶”，单击“层叠并缩放”，即可实现将女性人形图形复制到红色柱状图上。至此，即可实现每个柱形蓝色是男性人形，红色是女性人形。
...
6.2 **利用一些新型的高级图表来展示数据**

5.1 使用excel提供的树状图、旭日图、直方图、箱型图、瀑布图...

5.2 使用excel提供的强大的“power map插件”...（在插入-应用商店即可获取）

5.3 使用在线图表制作工具，如“图表秀”，但得注意数据保密性较高时不宜使用...（文字云、雷达图、桑基图、面积图和河流图等高级图表）
...
处理：分条列点，对称排版，注重整体的重心。


场景二：一张ppt图、表、文字都有

处理：分不同功能区，表图文左中右，或者表左图文右。
